...
import com.Proyecto.backEnd.exception.UsuarioNoEncontradoException;
...
public class UsuariosService {
    ...
    */
    ...
    public UsuariosModel buscarPorLogin(String login) throws UsuarioNoEncontradoException {

        Optional<UsuariosModel> usuario = usuariosRepo.findByLogin(login);

        if (usuario.isEmpty()) {
            throw new UsuarioNoEncontradoException("Usuario no encontrado: " + login);
        }
